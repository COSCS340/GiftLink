...
**Figure 5.** This is our dedicated page for our privacy policy.
 ...
 - Curate and reduce the list of suggested gifts to make the process more focused/seamless  
  ...
  ## Team
 &ensp;&ensp;&ensp;&ensp;The Socially Gifted team was able to effectively distribute the workload of this project amongst team members in order to accomplish the goals that we set for ourselves throughout the duration of the semester. The roles of each member remained mostly static throughout the project and can be seen below.
